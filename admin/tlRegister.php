<div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Add TL</div>
                            </div>
...
mysql_query("insert into tl_users(fname,onames,phone,idno,email,town,gender,availability,work_level,password) values('$firstname','$lastname','$phone','$id_no','$email','$town','$gender','$availability','$worklevel','$password')")or die(mysql_error());
?>
<script>
