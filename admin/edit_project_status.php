    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
				...
				<?php include('edit_project_status_form.php'); ?>		 
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Project Status List</div>
                            </div>
                            <div class="block-content collapse in">
								...
								<form action="delete_batl_status.php" method="post">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
													<?php
													$project_status = mysql_query("select * from project_status")or die(mysql_error());
													while($row = mysql_fetch_array($project_status)){
													$id = $row['id'];
													?>
