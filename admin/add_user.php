...
mysql_query("insert into users (email,password,firstname,lastname) values('$email','$password','$firstname','$lastname')")or die(mysql_error());

mysql_query("insert into activity_log (date,email,action) values(NOW(),'$email','Add User $username')")or die(mysql_error());
?>
<script>
