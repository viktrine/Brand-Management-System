                     ...
                     <div class="row-fluid"> 
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">BAs</div>
                            </div>
                                ...
                                <div class="span12">
									...
									<?php include('modal_delete.php'); ?>
										...
										<tbody>
												...
												<?php
											$subject_query = mysql_query("select * from ba_users")or die(mysql_error());
											...
											<tr>
													...
													<td width="30"><a href="edit_ba_user.php<?php echo '?id='.$id; ?>" class="btn btn-success"><i class="icon-pencil"></i> </a></td>
										</tr>
