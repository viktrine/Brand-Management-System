                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<form id="add_student" method="post">
                                        ...
                                        <div class="control-group">
                                          <div class="controls">
                                            <input  name="em" class="input focused" id="focusedInput" type="email" placeholder = "Valid Email Address" required>
                                          </div>
                                        </div>
				...
				$("#add_student").submit(function(e){
					...
					$.ajax({
						...
						success: function(html){
							$.jGrowl("Student Added Successfully", { header: 'Student Added' });
