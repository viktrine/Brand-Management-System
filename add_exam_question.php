...
<body>
		...
		if ($type  == '2'){
				mysql_query("insert into exam_question (quiz_id,question_text,date_added,answer,question_type_id) 
		...
		$query = mysql_query("select * from exam_question order by quiz_question_id DESC LIMIT 1")or die(mysql_error());
