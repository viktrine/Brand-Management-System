                                ...
                                <div class="span12">
									...
									<a href="teacher_exam.php" class="btn btn-info"><i class="icon-arrow-left"></i> Back</a>
										...
										<div class="control-group">
											...
											<select name="quiz_id">
											<option></option>
												<?php  $query = mysql_query("select * from exam where teacher_id = '$session_id'")or die(mysql_error());
				...
				<tbody>
					...
					<?php } ?>
										...
										if (isset($_POST['save'])){
											...
											for($i=0; $i < $N; $i++)
											{
												mysql_query("insert into class_exam (teacher_class_id,quiz_time,quiz_id) values('$id[$i]','$time','$quiz_id')")or die(mysql_error());
												mysql_query("insert into notification (teacher_class_id,notification,date_of_notification,link) value('$id[$i]','$name_notification',NOW(),'student_exam_list.php')")or die(mysql_error());
											} ?>
											<script>
