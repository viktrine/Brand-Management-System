                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<?php
								$query = mysql_query("select * from exam where quiz_id = '$get_id'")or die(mysql_error());
								...
								?>
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="hidden" name="quiz_id" value="<?php echo $row['quiz_id']; ?>" id="inputEmail" placeholder="Exam Title">
										...
										<div class="control-group">
											...
											<div class="controls">
											<input type="text" value="<?php echo $row['quiz_description']; ?>" class="span8" name="description" id="inputPassword" placeholder="exam Description" required>
											</div>
										</div>										
										<div class="control-group">
										<div class="controls">										
										...
										mysql_query("update exam set quiz_title = '$quiz_title',quiz_description = '$description' where quiz_id = '$quiz_id'")or die(mysql_error());
										?>
										<script>
