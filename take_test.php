...
<?php
	...
	mysql_query("UPDATE student_class_quiz SET `student_quiz_time` = 3600, `grade` = $score  WHERE student_id = '$session_id' and class_quiz_id = '$class_quiz_id'")or die(mysql_error());
?>
<script>
