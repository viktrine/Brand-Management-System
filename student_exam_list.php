                ...
                <div class="span9" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
							...
							<?php 		$query = mysql_query("select * FROM class_exam 
										LEFT JOIN exam on class_exam.quiz_id = exam.quiz_id
										where teacher_class_id = '$get_id'  ")or die(mysql_error());
                                ...
                                <div class="span12">
									...
									<?php include('copy_to_backpack_modal.php'); ?>
  									<table cellpadding="0" cellspacing="0" border="0" class="table" id="">
										...
										<tbody>
                              		<?php
										$query = mysql_query("select * FROM class_exam 
										LEFT JOIN exam on class_exam.quiz_id = exam.quiz_id
										...
										$query1 = mysql_query("select * from student_class_exam where class_quiz_id = '$id' and student_id = '$session_id'")or die(mysql_error());
									...
									?>                              
										<tr>                     
                                         ...
                                         <td width="200">
										<?php if ($grade == ""){ ?>
											<a  data-placement="bottom" title="Take This Exam" id="<?php echo $id; ?>Download" href="take_exam.php<?php echo '?id='.$get_id ?>&<?php echo 'class_quiz_id='.$id; ?>&<?php echo 'test=ok' ?>&<?php echo 'quiz_id='.$quiz_id; ?>&<?php echo 'quiz_time='.$quiz_time;	 ?>"><i class="icon-check icon-large"></i> Take This Exam</a>
										<?php }else{ ?>
